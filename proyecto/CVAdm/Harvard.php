...
<body>
    <div class="cv-container" id="cv-content">
        <div class="cv-header">
            <h1><?php echo htmlspecialchars($datosPersonales['nombre_datos'] ?? 'Nombre del Usuario'); ?></h1>
            <?php if ($datosPersonales): ?>
                ...
                <?php if (!empty($datosPersonales['licenciatura_datos'])): ?>
                    ...
                    <?php echo !empty($datosPersonales['porcentaje_creditos']) ? htmlspecialchars($datosPersonales['porcentaje_creditos']) . '% de créditos concluidos en la UAM Azcapotzalco' : ''; ?></p>
                <?php endif; ?>
            <?php endif; ?>
        </div>
