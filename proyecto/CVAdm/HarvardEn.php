...
<head>
    ...
    <title>Curriculum Vitae - Harvard Style (English)</title>
...
<body>
    <div class="cv-container" id="cv-content">
        <div class="cv-header">
            <h1><?php echo htmlspecialchars($datosPersonales['nombre_datos'] ?? 'User Name'); ?></h1>
            <?php if ($datosPersonales): ?>
                ...
                <?php if (!empty($datosPersonales['licenciatura_datos'])): ?>
                    <p><?php echo htmlspecialchars($datosPersonales['licenciatura_datos']); ?> - 
                    <?php echo !empty($datosPersonales['porcentaje_creditos']) ? htmlspecialchars($datosPersonales['porcentaje_creditos']) . '% of credits completed at UAM Azcapotzalco' : ''; ?></p>
                <?php endif; ?>
            <?php endif; ?>
        </div>
