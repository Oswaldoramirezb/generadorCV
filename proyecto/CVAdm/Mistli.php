...
<body>
    <div id="cv-content" class="container">
        <div class="left">
            ...
            <p class="p1"><?php echo htmlspecialchars($datosPersonales['correo_datos'] ?? 'email@ejemplo.com'); ?></p>
            <p class="p1"><?php echo htmlspecialchars($datosPersonales['ciudad_datos'] ?? 'Ciudad'); ?></p>
            <hr class="hr1">
        ...
        <div class="right">
            <div class="cv-header">
                ...
                <p><?php echo htmlspecialchars($datosPersonales['licenciatura_datos'] ?? 'Carrera'); ?></p>
