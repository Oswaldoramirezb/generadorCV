...
<body>
    <div id="cv-content" class="container">
        <div class="left">
            ...
            <p class="p1"><?php echo $datosPersonales['correo_datos'] ?? 'email@example.com'; ?></p>
            <p class="p1"><?php echo $datosPersonales['ciudad_datos'] ?? 'City'; ?></p>
            <hr class="hr1">
        ...
        <div class="right">
            <div class="cv-header">
                ...
                <p><?php echo $datosPersonales['licenciatura_datos'] ?? 'Degree'; ?></p>
